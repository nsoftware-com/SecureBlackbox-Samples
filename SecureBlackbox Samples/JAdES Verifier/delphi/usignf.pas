...
uses
  ...
  SBxCertificatemanager, SBxJAdESVerifier;
...
type
  TFormUsign = class(TForm)
    ...
    btnOK: TButton;
    btnCancel: TButton;
    lSignatureIndex: TLabel;
    lIssuerRDN: TLabel;
    edIssuerRDN: TEdit;
    edSignatureIndex: TEdit;
  ...
  public
    { Public declarations }
    procedure Init(Verifier: TsbxJAdESVerifier; Index : Integer; const IssuerRDN: string;
...
procedure TFormUsign.Init(Verifier: TsbxJAdESVerifier; Index : Integer; const IssuerRDN: string;
  const SerialNumber: TBytes; const SubjectKeyID: TBytes);
begin
  FVerifier := Verifier;

  edSignatureIndex.Text := IntToStr(Index);
