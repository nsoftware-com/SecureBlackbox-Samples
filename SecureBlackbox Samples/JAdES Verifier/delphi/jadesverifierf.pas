...
type
  ...
  private
    ...
    procedure DoSignatureFound(Sender: TObject; index: integer; const IssuerRDN: string; SerialNumber: TBytes;
...
procedure TFormJadesverifier.DoSignatureFound(Sender: TObject; index: integer; const IssuerRDN: string; SerialNumber: TBytes;
  SubjectKeyID: TBytes; CertFound: Boolean; var ValidateSignature: Boolean; var ValidateChain: Boolean);
var
  frmSign: TFormUsign;
begin
