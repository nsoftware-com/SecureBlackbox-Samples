...
type
  ...
  private
    ...
    procedure DoSignatureValidated(Sender: TObject; index: Integer; const IssuerRDN: String;
      SerialNumber: TBytes; SubjectKeyID: TBytes; ValidationResult: Integer);
  public
...
begin
  ...
  FSigner.NewSignature.Level := pslBES;
...
procedure TFormPDFProcessor.DoSignatureValidated(Sender: TObject; index: Integer; const IssuerRDN: String;
  SerialNumber: TBytes; SubjectKeyID: TBytes; ValidationResult: Integer);
begin
