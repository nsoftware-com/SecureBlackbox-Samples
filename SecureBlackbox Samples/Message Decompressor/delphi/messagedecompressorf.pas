...
uses
  ...
  SBxTypes, SBxCore, SBxUtils, SBxMessageDecompressor;
...
begin
  try
    ...
    FormResults.mResults.Lines.Add('Content Type: ' + FUtils.OidToString(TEncoding.UTF8.GetBytes(FDecompressor.Config('ContentType'))));
