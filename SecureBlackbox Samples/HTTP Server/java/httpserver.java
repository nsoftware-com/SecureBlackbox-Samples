...
public class httpserver extends ConsoleDemo {
    ...
    try {
      server.addHTTPServerEventListener(new HTTPServerEventListener() {
        ...
        public void getRequest(HTTPServerGetRequestEvent e) {
          System.out.println("Request received (page: " + e.URI + ")");
      ...
      System.out.println("HTTP server started on port " + server.getPort() + ". Press enter to stop server.");
      input();
