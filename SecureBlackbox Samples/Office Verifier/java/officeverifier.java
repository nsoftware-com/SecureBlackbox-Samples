...
class officeverifier extends JDialog {
	...
	public static void main(String[] args) {
		try {
			officeverifier dialog = new officeverifier();
	 ...
	 * Create the dialog.
	 */
	public officeverifier()
	{
		verifier = new Officeverifier();
		try {
			verifier.addOfficeverifierEventListener(new OfficeverifierEventListener() {
				@Override
				public void chainElementDownload(OfficeverifierChainElementDownloadEvent officeverifierChainElementDownloadEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainElementNeeded(OfficeverifierChainElementNeededEvent officeverifierChainElementNeededEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainElementStore(OfficeverifierChainElementStoreEvent officeverifierChainElementStoreEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainValidated(OfficeverifierChainValidatedEvent officeverifierChainValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainValidationProgress(OfficeverifierChainValidationProgressEvent officeverifierChainValidationProgressEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void documentLoaded(OfficeverifierDocumentLoadedEvent officeverifierDocumentLoadedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void error(OfficeverifierErrorEvent officeverifierErrorEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void notification(OfficeverifierNotificationEvent officeverifierNotificationEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void signatureFound(OfficeverifierSignatureFoundEvent e) {
					if (e.certFound) {
						e.validateSignature = true;
						e.validateChain = true;
					} else {
						signdialog frmSign = new signdialog(verifier);
						try {
				...
				@Override
				public void signatureValidated(OfficeverifierSignatureValidatedEvent officeverifierSignatureValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void timestampFound(OfficeverifierTimestampFoundEvent officeverifierTimestampFoundEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void timestampValidated(OfficeverifierTimestampValidatedEvent officeverifierTimestampValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSCertNeeded(OfficeverifierTLSCertNeededEvent officeverifierTLSCertNeededEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSCertValidate(OfficeverifierTLSCertValidateEvent officeverifierTLSCertValidateEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSEstablished(OfficeverifierTLSEstablishedEvent officeverifierTLSEstablishedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSHandshake(OfficeverifierTLSHandshakeEvent officeverifierTLSHandshakeEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSShutdown(OfficeverifierTLSShutdownEvent officeverifierTLSShutdownEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void supercoreIntercept(OfficeverifierSupercoreInterceptEvent officeverifierSupercoreInterceptEvent) {
					// TODO Auto-generated method stub
				}
			});
		}
		...
		JLabel lblCaption = new JLabel("This demo gives an example of using OfficeVerifier component to process signed office documents.");
