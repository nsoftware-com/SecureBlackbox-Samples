...
begin
  ...
  begin
    ...
    try
      ...
      UserManager.Users[0].Username := FormUsersettings.editUsername.Text;
      UserManager.Users[0].Password := FormUsersettings.editPassword.Text;
      UserManager.Users[0].IncomingSpeedLimit := SpeedLimit;
      UserManager.Users[0].OutgoingSpeedLimit := SpeedLimit;
      UserManager.Users[0].BasePath := FormUsersettings.editHomeDirectory.Text;

      FServer.Users.Add(UserManager.Users[0]);

      OutputUserInfo(nil, UserManager.Users[0]);
    finally
