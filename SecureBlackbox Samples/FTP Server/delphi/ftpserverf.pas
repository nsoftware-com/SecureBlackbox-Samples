...
type
  ...
  private
    ...
    procedure Server_AuthAttempt(Sender: TObject; ConnectionID: Int64; const Username, Password: string; var Allow: Boolean);
...
begin
  ...
  try
    ...
    UserManager.Load('Users.dat', '@WE$rt65');
...
procedure TFormFtpserver.Server_Error(Sender: TObject; ErrorCode: integer; const Description: string);
var
  Item: PUMListItem;
begin
  if FFinalizing then
...
procedure TFormFtpserver.Server_AuthAttempt(Sender: TObject; ConnectionID: Int64;
  const Username, Password: string; var Allow: Boolean);
var
  Item: PUMListItem;
begin
  if FFinalizing then
...
begin
  ...
  begin
    ...
    begin
      ...
      Server.ServerCertificates.Clear();
      ...
      begin
        ...
        try
          try
            ...
            Server.ServerCertificates.Add(CertificateManager.Certificate);
          except
...
begin
  ...
  try
    ...
    /// NEVER USE THIS PASSWORD IN REAL PROJECT. IT IS NOT SAFE. EVERYONE KNOWS IT !!!!!!!!!!!!!!
    UserManager.Save('Users.dat', '@WE$rt65');
  finally
    FreeAndNil(UserManager);
  end;
end;
