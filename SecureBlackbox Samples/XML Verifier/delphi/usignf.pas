...
uses
  ...
  SBxTypes, SBxCore, SBxCertificateManager, SBxXMLVerifier;
...
type
  ...
  public
    { Public declarations }
    procedure SetSignature(Value: TsbxXMLVerifier; SigIndex : Integer);
  end;
...
procedure TFormUsign.SetSignature(Value: TsbxXMLVerifier; SigIndex : Integer);
begin
  FVerifier := Value;
