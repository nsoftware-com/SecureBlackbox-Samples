...
class dtlsclient
{
    ...
    private static void _client_OnTLSCertValidate(object sender, DTLSClientTLSCertValidateEventArgs e)
    {
        if (client.TLSServerChain.Count == 0)
            return;
        // do not do this in production code
        e.Accept = true;
        Console.WriteLine("Server certificate recived: " + client.TLSServerChain[0].Subject);
    }
