...
type
  ...
  public
    { Public declarations }
    procedure Init(Verifier: TsbxPDFVerifier; const IssuerRDN: string;
...
procedure TFormUsign.Init(Verifier: TsbxPDFVerifier; const IssuerRDN: string;
  const SerialNumber: TBytes; const SubjectKeyID: TBytes);
begin
  FVerifier := Verifier;

  edSignatureName.Text := FVerifier.Signatures[0].SignatureName;
