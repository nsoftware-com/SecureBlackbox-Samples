object FormPdfverifier: TFormPdfverifier
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'PDF Verifier demo'
  ClientHeight = 301
  ClientWidth = 699
  Color = clBtnFace
  ...
  object Label10: TLabel
    ...
    Height = 13
    Caption = 
      'This sample illustrates the use of PDFVerifier component for val' +
      'idating PDF signatures. '
    Font.Charset = DEFAULT_CHARSET
