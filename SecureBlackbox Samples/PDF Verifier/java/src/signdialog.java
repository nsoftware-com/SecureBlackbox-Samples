...
class signdialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public signdialog(Pdfverifier _verifier, Integer sigIndex, String issuerRDN, byte[] serialNumber, byte[] subjectKeyID)
	{
		...
		edSignatureName = new JTextField();
		edSignatureName.setBounds(110, 20, 235, 22);
		edSignatureName.setEnabled(false);
		contentPanel.add(edSignatureName);
		...
		if (verifier != null)
		{
			edSignatureName.setText(verifier.getSignatures().item(sigIndex).getSignatureName());
		}
