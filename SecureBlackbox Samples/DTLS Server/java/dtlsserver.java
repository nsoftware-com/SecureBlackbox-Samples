...
public class dtlsserver extends ConsoleDemo {
	...
	public static void main(String[] args) {
		...
		try {
			server.addDTLSServerEventListener(new DTLSServerEventListener() {
				@Override
				public void accept(DTLSServerAcceptEvent e) {
					e.accept = true;
					System.out.println("Accepted a new client from " + e.remoteAddress + ":" + e.remotePort);
				}

				@Override
				public void data(DTLSServerDataEvent e) {
				...
				@Override
				public void externalSign(DTLSServerExternalSignEvent e) {

				}

				@Override
				public void notification(DTLSServerNotificationEvent e) {

				}

				@Override
				public void plainData(DTLSServerPlainDataEvent e) {

				}

				@Override
				public void TLSCertValidate(DTLSServerTLSCertValidateEvent e) {

				}

				@Override
				public void TLSEstablished(DTLSServerTLSEstablishedEvent e) {
					System.out.println(" [" + e.connectionID + "] Secure session established");
				}

				@Override
				public void TLSHandshake(DTLSServerTLSHandshakeEvent e) {

				}

				@Override
				public void TLSPSK(DTLSServerTLSPSKEvent e) {

				}

				@Override
				public void TLSShutdown(DTLSServerTLSShutdownEvent e) {
					System.out.println(" [" + e.connectionID + "] Secure session closed");
				}

				@Override
				public void supercoreIntercept(DTLSServerSupercoreInterceptEvent e) {
			...
			System.out.println("DTLS server started on port " + server.getPort() + ". Press enter to stop server");
			input();
