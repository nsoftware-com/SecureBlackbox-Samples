...
procedure TFormKeyring.btnPubClick(Sender: TObject);
begin
  if OpenKeyring then
  begin
...
procedure TFormKeyring.btnSecClick(Sender: TObject);
begin
  if OpenKeyring then
  begin
...
procedure TFormKeyring.edtPubChange(Sender: TObject);
begin
  btnOK.Enabled := edtPub.Text <> '';
end;

procedure TFormKeyring.edtSecChange(Sender: TObject);
begin
  btnOK.Enabled := edtPub.Text <> '';
end;
