...
begin
  ...
  begin
    ...
    case Sig.Level of
      aslGeneric: edLevel.Text := 'Generic';
      ...
      aslExtendedX: edLevel.Text := 'Extended X';
      aslExtendedXType1: edLevel.Text := 'Extended XType1';
      aslExtendedXType2: edLevel.Text := 'Extended XType2';
      aslExtendedXLong: edLevel.Text := 'Extended XLong';
      aslExtendedXL: edLevel.Text := 'Extended XL';
