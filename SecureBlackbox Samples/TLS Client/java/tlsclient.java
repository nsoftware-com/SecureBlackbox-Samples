...
public class tlsclient extends ConsoleDemo {
  ...
  public static void main(String[] args) {
    ...
    try {
      client.addTLSClientEventListener(new TLSClientEventListener() {
        @Override
        ...
        @Override
        public void supercoreIntercept(TLSClientSupercoreInterceptEvent e) {
      ...
      client.getSocketSettings().setTimeout(4000);
      ...
      while (true) {
        String[] commands = translateCommandline(prompt("tls", ">"));
