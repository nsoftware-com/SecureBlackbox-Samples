...
type
  ...
  private
    ...
    procedure DoSignatureFound(Sender: TObject; Scope: Integer; const IssuerRDN: String;
      SerialNumber: TBytes; SubjectKeyID: TBytes; CertFound: Boolean; Last: Boolean;
...
procedure TFormCadesverifier.DoSignatureFound(Sender: TObject; Scope: Integer;
  const IssuerRDN: String; SerialNumber: TBytes; SubjectKeyID: TBytes; CertFound: Boolean;
  Last: Boolean; var ValidateSignature: Boolean; var ValidateChain: Boolean);
var
  frmSign: TFormUsign;
begin
  if CertFound then
...
begin
  try
    ...
    case FVerifier.Signature.SignatureValidationResult of
      svtSignerNotFound:
