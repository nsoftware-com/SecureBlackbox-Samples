...
func signValidRes(value: XMLSignatureValidities) -> String {
    switch (value) {
        case XMLSignatureValidities.xsvValid: return "Valid"
        case XMLSignatureValidities.xsvCorrupted: return "Corrupted"
        case XMLSignatureValidities.xsvSignerNotFound: return "SignerNotFound"
        case XMLSignatureValidities.xsvFailure: return "Failure"
        case XMLSignatureValidities.xsvReferenceCorrupted: return "ReferenceCorrupted"
