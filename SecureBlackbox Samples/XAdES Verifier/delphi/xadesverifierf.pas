...
type
  ...
  private
    ...
    procedure DoSignatureFound(Sender: TObject; SigIndex : Integer;
      const IssuerRDN: string; SerialNumber: TBytes; SubjectKeyID: TBytes;
      CertFound: boolean; var ValidateSignature: boolean; var ValidateChain: boolean);
    procedure DoTimestampValidated(Sender: TObject; Index : Integer;
      const IssuerRDN: String; SerialNumber: TBytes;
      SubjectKeyID: TBytes; const Time: String; ValidationResult: Integer;
      ChainValidationResult: Integer; ChainValidationDetails: Integer);
  public
    { Public declarations }
  end;
...
procedure TFormXadesverifier.DoTimestampValidated(Sender: TObject; Index : Integer;
  const IssuerRDN: String; SerialNumber: TBytes; SubjectKeyID: TBytes; const Time: String;
  ValidationResult: Integer; ChainValidationResult: Integer; ChainValidationDetails: Integer);
begin
        ...
        case FVerifier.Signatures[I].SignatureValidationResult of
          ...
          begin
            ...
            begin
              ...
              if FVerifier.Signatures[I].XAdES then
