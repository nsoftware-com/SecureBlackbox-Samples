...
class messagecompressor
{
    ...
    static void Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                compressor.InputFile = optval(args, "-input");
            }
            else
            {
            ...
            {
                compressor.OutputFile = optval(args, "-output");
            }
            else
            {
            ...
            {
                compressor.CompressionLevel = int.Parse(optval(args, "-level"));
            }

            compressor.Compress();

            Console.WriteLine("The file successfully compressed.\n");
