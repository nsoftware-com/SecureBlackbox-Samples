...
public class messagecompressor extends ConsoleDemo {
	...
	public static void main(String[] args) {
		...
		try {
			if (optext(args, "-input")) {
				compressor.setInputFile(optval(args, "-input"));
			} else {
			...
			if (optext(args, "-output")) {
				compressor.setOutputFile(optval(args, "-output"));
			} else {
			...
			if (optext(args, "-level")) {
				compressor.setCompressionLevel(Integer.parseInt(optval(args, "-level")));
			}

			compressor.compress();

			System.out.println("The file successfully compressed.\n");
