  ...
  try
    ...
    begin
      ...
      try
        ...
        UserManager.Users[0].Username := UserForm.edName.Text;
        UserManager.Users[0].Password := UserForm.edPassword.Text;
        if FileExists(UserForm.edPublicKey.Text) then
          UserManager.Users[0].SSHKey := TFile.ReadAllBytes(UserForm.edPublicKey.Text);
...
begin
  ...
  try
    ...
    UserManager.Save('Users.dat', 'Asd$%sdf####f.>');
  finally
    FreeAndNil(UserManager);
  end;
