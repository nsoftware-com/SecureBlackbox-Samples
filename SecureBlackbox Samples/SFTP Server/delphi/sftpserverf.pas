...
procedure TFormSftpserver.Server_Error(Sender: TObject; ConnectionID: Int64; ErrorCode: Integer;
  Fatal: Boolean; Remote: Boolean; const Description: String);
var
  S: string;
begin
