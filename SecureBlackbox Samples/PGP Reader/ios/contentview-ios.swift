...
struct ContentView: View {
    ...
    private let keyringPickerStyle = WheelPickerStyle()
    ...
    private func loadButton() -> some View {
        Button(action: {
            ...
            do {
                ...
                try keyring.load(publicKeyringFile: documentsPath + pubFile, secretKeyringFile: documentsPath + secFile)
                autoSelect = true
                selectedDecKey = 0
                selectedVerKey = 0
                keysLoading = true
        ...
        Button(action: {
            ...
            do {
                if (keyring.secretKeys.count == 0) {
                    ...
                    reader.inputFile = documentsPath + inputFile
                    reader.outputFile = documentsPath + outputFile
