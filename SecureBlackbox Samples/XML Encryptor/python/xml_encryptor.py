...
def displayHelp():
    print(
        ...
        "            [-xmlnode xml_node] [-mimetype mime_type] [-external external_file] [-enckey] [-enckeytype encryption_key_type] \n"
        "            [-transport key_transport_method] [-wrap key_wrap_method] [-cert certificate_file] [-certpass certificate_password] [-pass key_password] \n\n"
        "DESCRIPTION\n"
