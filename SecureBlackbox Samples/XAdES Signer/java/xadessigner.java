...
import static secureblackbox.Xadessigner.*;

class xadessigner extends JDialog {
	...
	public static void main(String[] args) {
		try {
			xadessigner dialog = new xadessigner();
	...
	public xadessigner()
	{
		...
		try
		{
			signer.addXadessignerEventListener(new XadessignerEventListener() {
				@Override
				public void chainElementDownload(XadessignerChainElementDownloadEvent xadessignerChainElementDownloadEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainElementNeeded(XadessignerChainElementNeededEvent xadessignerChainElementNeededEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainElementStore(XadessignerChainElementStoreEvent xadessignerChainElementStoreEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainValidated(XadessignerChainValidatedEvent xadessignerChainValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void chainValidationProgress(XadessignerChainValidationProgressEvent xadessignerChainValidationProgressEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void documentLoaded(XadessignerDocumentLoadedEvent xadessignerDocumentLoadedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void error(XadessignerErrorEvent xadessignerErrorEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void externalSign(XadessignerExternalSignEvent xadessignerExternalSignEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void formatElement(XadessignerFormatElementEvent xadessignerFormatElementEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void formatText(XadessignerFormatTextEvent xadessignerFormatTextEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void notification(XadessignerNotificationEvent xadessignerNotificationEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void referenceValidated(XadessignerReferenceValidatedEvent xadessignerReferenceValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void resolveReference(XadessignerResolveReferenceEvent xadessignerResolveReferenceEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void signatureFound(XadessignerSignatureFoundEvent xadessignerSignatureFoundEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void signatureValidated(XadessignerSignatureValidatedEvent xadessignerSignatureValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void timestampFound(XadessignerTimestampFoundEvent xadessignerTimestampFoundEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void timestampRequest(XadessignerTimestampRequestEvent xadessignerTimestampRequestEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void timestampValidated(XadessignerTimestampValidatedEvent xadessignerTimestampValidatedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSCertNeeded(XadessignerTLSCertNeededEvent xadessignerTLSCertNeededEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSCertValidate(XadessignerTLSCertValidateEvent xadessignerTLSCertValidateEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSEstablished(XadessignerTLSEstablishedEvent xadessignerTLSEstablishedEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSHandshake(XadessignerTLSHandshakeEvent xadessignerTLSHandshakeEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void TLSShutdown(XadessignerTLSShutdownEvent xadessignerTLSShutdownEvent) {
					// TODO Auto-generated method stub
				}

				@Override
				public void supercoreIntercept(XadessignerSupercoreInterceptEvent xadessignerSupercoreInterceptEvent) {
					// TODO Auto-generated method stub
				}
			});
		}
		...
		panel_4.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "XAdES options", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_4.setBounds(370, 95, 350, 130);
		...
		cbTimestamp.setBounds(6, 75, 250, 23);
		panel_4.add(cbTimestamp);

		edTimestampServer = new JTextField();
		edTimestampServer.setText("http://");
		edTimestampServer.setBounds(15, 100, 320, 20);
		panel_4.add(edTimestampServer);
	...
	protected void sign()
	{
		try {
			...
			switch (cmbCanonMethod.getSelectedIndex()) {
				case 0: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmCanon);
					break;
				}
				case 1: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmCanonComment);
					break;
				}
				case 2: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmCanon_v1_1);
					break;
				}
				case 3: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmCanonComment_v1_1);
					break;
				}
				case 4: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmExclCanon);
					break;
				}
				case 5: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmExclCanonComment);
					break;
				}
				case 6: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmMinCanon);
					break;
				}
				default: {
					signer.getNewSignature().setCanonicalizationMethod(XAdESSignature.cxcmCanon);
			...
			// XAdES options
			switch (cmbVersion.getSelectedIndex()) {
				case 0: {
					signer.getNewSignature().setXAdESVersion(XAdESSignature.xav111);
					break;
				}
				case 1: {
					signer.getNewSignature().setXAdESVersion(XAdESSignature.xav122);
					break;
				}
				case 3: {
					signer.getNewSignature().setXAdESVersion(XAdESSignature.xav141);
					break;
				}
				default: {
					signer.getNewSignature().setXAdESVersion(XAdESSignature.xav132);
					break;
				}
			}

			switch (cmbForm.getSelectedIndex())
			{
				case 0:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafBasic);
					break;
				}
				case 1:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafBES);
					break;
				}
				case 2:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafEPES);
					break;
				}
				case 3:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafT);
					break;
				}
				case 4:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafC);
					break;
				}
				case 5:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafX);
					break;
				}
				case 6:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafXL);
					break;
				}
				case 7:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafA);
					break;
				}
				case 8:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedBES);
					break;
				}
				case 9:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedEPES);
					break;
				}
				case 10:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedT);
					break;
				}
				case 11:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedC);
					break;
				}
				case 12:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedX);
					break;
				}
				case 13:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedXLong);
					break;
				}
				case 14:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedXL);
					break;
				}
				case 15:
				{
					signer.getNewSignature().setXAdESForm(XAdESSignature.xafExtendedA);
					break;
				}
				default:
				{
