...
public class dcauthservice extends ConsoleDemo
{
	...
	public static void main(String[] args) {
		...
		else
		{
			try
			{
				...
				webserver.addHttpserverEventListener(new DefaultHttpserverEventListener() {
					@Override
	...
	public static String signAsyncRequest(String request)
	{
		...
		try {
			...
			auth.setSigningCertificate(new Certificate(certfile));
			auth.setCertPassword(certpass);
